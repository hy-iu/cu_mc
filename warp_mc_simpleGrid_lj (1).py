...
class ParticleSystem:
    def __init__(self):
        print(f"RADIUS={RADIUS}, L={L}, L_GRID={L_GRID}, GRID_CELL_SIZE={GRID_CELL_SIZE}, MAX_GRID_SIZE={MAX_GRID_SIZE}, NUM_GRIDS={NUM_GRIDS}")
